...
-- ==============================================================================
-- INITIAL SEED DATA FOR DEMO STUDIO ("Bloom Studio")
-- ==============================================================================

INSERT INTO businesses (id, name, slug, owner, category, description, phone, address, hours, booking_policy, cancellation_policy, deposit_policy, faqs, rules)
VALUES (
  'bloom',
  'Bloom Studio',
  'bloom',
  ...
  'A calm space for hair, nails, and slow beauty.',
  '+1 415 555 2671',
  ...
  'A small deposit is required to secure your appointment.',
  '[
    {"question": "How do I reschedule?", "answer": "You can reschedule directly using your booking code or the link in your confirmation."},
    {"question": "Is parking available?", "answer": "Yes, complimentary customer parking is available behind the studio."}
  ]'::jsonb,
  '{"minNoticeMinutes": 60, "maxAdvanceDays": 30, "slotMinutes": 30}'::jsonb
)
ON CONFLICT (id) DO NOTHING;

INSERT INTO staff (id, business_id, name, role, initials, email, phone)
VALUES
  ('jessica', 'bloom', 'Jessica Miller', 'Master Stylist & Founder', 'JM', 'jessica@bloomstudio.com', '+1 415 555 2671'),
  ('amaka', 'bloom', 'Amaka Okafor', 'Senior Braider & Texture Specialist', 'AO', 'amaka@bloomstudio.com', '+1 415 555 2672'),
  ('linda', 'bloom', 'Linda Chen', 'Nail Artist & Esthetician', 'LC', 'linda@bloomstudio.com', '+1 415 555 2673')
ON CONFLICT (id) DO NOTHING;

INSERT INTO services (id, business_id, name, description, duration, price, deposit, staff_ids, active)
VALUES
  ('haircut', 'bloom', 'Signature Haircut', 'Consultation, wash, tailored cut, and signature blowout finish.', 45, 85, 25, '["jessica", "amaka"]'::jsonb, TRUE),
  ('braids', 'bloom', 'Knotless Braids', 'Tension-free medium knotless braids with parting and scalp treatment.', 180, 220, 50, '["amaka"]'::jsonb, TRUE),
  ('manicure', 'bloom', 'Gel Manicure', 'Detailed cuticle care, shaping, long-lasting gel application, and hand massage.', 60, 55, 20, '["linda"]'::jsonb, TRUE),
  ('styling', 'bloom', 'Silk Press & Treatment', 'Deep conditioning steam treatment followed by a sleek silk press.', 120, 130, 35, '["jessica", "amaka"]'::jsonb, TRUE)
ON CONFLICT (id) DO NOTHING;
